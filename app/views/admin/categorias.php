...
<body>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formEditarCategoria">
                        ...
                        <div class="mb-3">
                            <label for="editarNombre" class="form-label gestion-categorias-form-label">Nombre de la categoría</label>
                            <input type="text" id="editarNombre" class="form-control gestion-categorias-form-input" required
                                pattern="^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$"
                                title="El nombre de la categoría no puede contener números ni caracteres especiales"
                                maxlength="100">
                            <small class="form-text text-muted">
                                Máximo 100 caracteres.
                                <span id="nombreCategoriaCounter">0/100</span>
                            </small>
                        </div>

                        <!-- Descripción -->
                        <div class="mb-3">
                            <label for="editarDescripcion" class="form-label gestion-categorias-form-label">Descripción</label>
                            <textarea id="editarDescripcion" class="form-control gestion-categorias-form-input" rows="3"
                                title="Agregue una descripción para la categoría"></textarea>
                        </div>

                        <!-- Foto -->
                        <div class="mb-3">
                            <label for="editarImagen" class="form-label gestion-categorias-form-label">Foto</label>
                            <input type="file" id="editarImagen" class="form-control gestion-categorias-form-input"
                                accept="image/*"
                                title="Seleccione una imagen para la categoría" required>
                            <small class="form-text text-muted">Formatos permitidos: JPG, PNG, GIF.</small>
                        </div>

                        <!-- Botón Actualizar -->
                        <button type="submit" class="gestion-clientes-boton-modal">
                            <span id="textoDinamicoCategoria"></span>
                        </button>
                    </form>
    ...
    <script>
        //Variables globales
        let textoModal = document.getElementById("textoDinamicoCategoria");
